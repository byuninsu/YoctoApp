...
typedef enum {
    ...
    NVRAM_SSD0_MODEL_NO    = 0x68,   
    NVRAM_SSD0_SERIAL_NO   = 0x88,   
    NVRAM_SSD1_MODEL_NO    = 0xA8,   
    NVRAM_SSD1_SERIAL_NO   = 0xC8,   
    NVRAM_SW_PART_NO       = 0xE8,   
    NVRAM_SW_SERIAL_NO     = 0x108,
    
    NVRAM_QT_TEST_ADDR     = 0x128 
} NvramAddress;
