...
# P3
echo "Forcing CMODE, Using SGMII AN results for P3"
mdio-tool w $INTERFACE 0x05 0x1A 0xA100
mdio-tool w $INTERFACE 0x04 0x1A 0xFC60

# Set Ports in SGMII mode
echo "Setting ports in SGMII mode for P3"
mdio-tool w $INTERFACE 0x03 0x00 0x000A

# Force SGMII PHY Mode, SPEED 1000Mbps
# P3
echo "Forcing SGMII PHY mode, Speed 1000Mbps for P3"
mdio-tool w $INTERFACE 0x05 0x1A 0x0A02
mdio-tool w $INTERFACE 0x04 0x1A 0xFC62

# Reset SERDES
# Port 3
echo "Resetting SERDES for Port 3"
...
echo "Setting port state to forwarding for P3"
