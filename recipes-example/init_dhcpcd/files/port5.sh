...
# Clear power down bit and reset SERDES P5
echo "Clearing power down bit and resetting SERDES P5"
mdio-tool w eth0 0x1C 0x19 0x2000
mdio-tool w eth0 0x1C 0x18 0x82A4
mdio-tool w eth0 0x1C 0x19 0x0A040
mdio-tool w eth0 0x1C 0x18 0x86A4

# Fix 1000Base-X AN advertisement
# Write 4.2004.5 to 1 (Address 0x15)
...
mdio-tool w eth0 0x05 0x04 0x007F
